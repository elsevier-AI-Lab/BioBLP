...
from pykeen.models import ERModel, RotatE, TransE, ComplEx
...
# TODO: Generalize to other models -- For now duplicate the class.
class BioBLPR(RotatE):
    def __init__(self, *,
